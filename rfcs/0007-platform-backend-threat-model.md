...
Sandboxed policies require explicit backend capability for filesystem policy, runtime roots, runtime environment redirects, process isolation, process cleanup, and the requested network mode.
