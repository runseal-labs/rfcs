...
- Breaking changes to provisional code, fixtures, tests, CLI flags, JSON fields, audit shapes, and draft semantics are expected while the public contract is being established; choose the clean current design over preserving prior local behavior.
